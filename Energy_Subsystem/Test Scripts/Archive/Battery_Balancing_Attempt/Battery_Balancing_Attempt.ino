...
void loop() {
  ...
  if (int_count == 400) { // Relay switching is 10ms. Double for safety
    analogWrite(A7,1);
  } else if (int_count == 420) { // Read battery 1 voltage
    V_1 = analogRead(A1)*4.096/1.03;
  } else if (int_count == 430) {
    analogWrite(A7,0);
  } else if (int_count == 450) {
    analogWrite(A6,1);
  } else if (int_count == 470) {
    V_2 = analogRead(A1)*4.096/1.03;
  } else if (int_count == 480) {
    analogWrite(A6,0);
  } else if (int_count == 500) {
    analogWrite(A0,1);
  } else if (int_count == 520) {
