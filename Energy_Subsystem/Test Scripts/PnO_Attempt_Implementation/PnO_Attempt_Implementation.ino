...
void loop() {
  ...
  if (loop_trigger == 1){
      ...
      closed_pwm = pidv(ev);  //voltage pid
  ...
  if (int_count == 1000) { 
    ...
    dataString = String(state_num) + "," + String(vref/1000) + "," + String(V_pv/1000) + "," + String(current_measure/1000) + "," + String(p0/1000000); //build a datastring for the CSV file
