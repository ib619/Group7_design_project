    ...
    if (valid_rgbhsv) begin
        if (red_detect) begin	//Update bounds when the pixel is red
            ...
            r_y_max <= prev_y;
				...
				if ( (prev_y - b_y_mid < 11'd60) |( b_x_diff < 11'd120)) begin
            ...
            g_y_max <= prev_y;
				...
				if ( (prev_y - gr_y_mid < 11'd60) |( gr_x_diff < 11'd120)) begin
	 ...
	 if (sop_in) begin	//Reset bounds on start of packet
		 r_x_min <= IMAGE_W-11'h1;b_x_min <= IMAGE_W-11'h1;b_x_min2 <= IMAGE_W-11'h1;g_x_min <= IMAGE_W-11'h1;gr_x_min <= IMAGE_W-11'h1;gr_x_min2 <= IMAGE_W-11'h1;y_x_min <= IMAGE_W-11'h1;
		 r_x_max <= 0;b_x_max <= 0;b_x_max2 <= 0;g_x_max <= 0;gr_x_max <= 0;gr_x_max2 <= 0;y_x_max <= 0;
		 r_y_min <= IMAGE_H-11'h1;b_y_min <= IMAGE_H-11'h1;b_y_min2 <= IMAGE_H-11'h1;g_y_min <= IMAGE_H-11'h1;gr_y_min <= IMAGE_H-11'h1;gr_y_min2 <= IMAGE_H-11'h1;y_y_min <= IMAGE_H-11'h1;
		 r_y_max <= 0;b_y_max <= 0;b_y_max2 <= 0;g_y_max <= 0;gr_y_max <= 0;gr_y_max2 <= 0;y_y_max <= 0;
		 bright_pix_count <= 0;
	 end
end
...
always@(posedge clk) begin
    ...
    if (msg_state != 5'd0)
        begin
            if (msg_state == 5'd16)  msg_state <= 5'd0;
