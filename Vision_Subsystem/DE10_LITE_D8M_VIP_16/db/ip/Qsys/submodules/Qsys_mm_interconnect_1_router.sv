...
(
    ...
    localparam PAD13 = log2ceil(64'h42100 - 64'h420f0); 
    localparam PAD14 = log2ceil(64'h42108 - 64'h42100); 
    localparam PAD15 = log2ceil(64'h42110 - 64'h42108); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h42110;
    ...
    // ( 0x420f0 .. 0x42100 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 19'h420f0   ) begin
            src_channel = 16'b0000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x42100 .. 0x42108 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 19'h42100  && read_transaction  ) begin
            src_channel = 16'b0000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x42108 .. 0x42110 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 19'h42108   ) begin
