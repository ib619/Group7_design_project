...
//************************** Motor Pins Defining **************************//
  ...
  //pinMode(PWMR, OUTPUT);
  //pinMode(PWML, OUTPUT);
  analogWrite(PWMR, 0);       //setting right motor speed at maximum
  analogWrite(PWML, 0);       //setting left motor speed at maximum
  //*******************************************************************//
...
//command reception loop
  if (Serial.available() && marsRover.command_running == 0 )
  {
    marsRover.command_running = 1;
    char message[30];
    ...
    marsRover.decodeCommand(mDistance, mSpeed, mDirection);
...
marsRover.moveForward(myOrientation.getTravelDistance());
marsRover.turnCW(myOrientation.getDirectionChangeAngle());
marsRover.turnACW(myOrientation.getDirectionChangeAngle());
